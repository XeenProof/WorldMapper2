        ...
        <>
            {
                ...
                : <LoggedIn fetchUser={props.fetchUser} setActiveList={props.setActiveList} logout={props.logout} redirect={props.redirect}  
                user={props.user} setShowUpdate={props.setShowUpdate}
                />
            }
        </>
